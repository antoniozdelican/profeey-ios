//
//  ProfileTableViewController2.swift
//  Profeey
//
...
class ProfileTableViewController2: UITableViewController {
...
//        // Get currentUser.
//        self.getCurrentUser()
        let user1 = User(userId: nil, firstName: "Mark", lastName: "Peric", preferredUsername: "marko", professionName: nil, profilePicUrl: nil, about: nil, locationName: nil, numberOfFollowers: nil, numberOfPosts: nil, topCategories: nil)
        self.user = user1
    }
...
//            return self.educationExperiences.count
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        case 0:
            ...
            case 0:
                let cell = tableView.dequeueReusableCell(withIdentifier: "cellProfileMain", for: indexPath) as! ProfileMainTableViewCell2
            ...
            case 1:
                ...
                cell.numberOfPostsButton.addTarget(self, action: #selector(ProfileTableViewController2.postsButtonTapped(_:)), for: UIControlEvents.touchUpInside)
                cell.numberOfFollowersButton.setTitle(self.user?.numberOfFollowersInt.numberToString(), for: UIControlState())
                cell.numberOfFollowersButton.addTarget(self, action: #selector(ProfileTableViewController2.followersButtonTapped(_:)), for: UIControlEvents.touchUpInside)
                ...
                if self.isCurrentUser {
                    cell.setEditButton()
                    cell.followButton.addTarget(self, action: #selector(ProfileTableViewController2.editButtonTapped(_:)), for: UIControlEvents.touchUpInside)
                } else {
                    self.isFollowing ? cell.setFollowingButton() : cell.setFollowButton()
                    cell.followButton.addTarget(self, action: #selector(ProfileTableViewController2.followButtonTapped(_:)), for: UIControlEvents.touchUpInside)
                }
                return cell
            case 2:
...
//            cell.timePeriodLabel.text = educationExperience.timePeriod
    ...
    override func tableView(_ tableView: UITableView, viewForHeaderInSection section: Int) -> UIView? {
        ...
        case 3:
            ...
            cell.editButton?.addTarget(self, action: #selector(ProfileTableViewController2.editExperiencesButtonTapped(_:)), for: UIControlEvents.touchUpInside)
            cell.contentView.backgroundColor = UIColor.white
            return cell.contentView
        case 4:
            guard self.selectedSegment == 1 else {
...
extension ProfileTableViewController2: LikeDelegate {
